...
from torch_geometric.nn import DataParallel, MessagePassing
from torch_scatter import scatter

from DataClasses import Dataset, choose_dataloader, lmdb_dataset
from ModelFunctions import evaluate, inference, multigpu_available, train
...
def createParser():
    ...
    parser.add_argument(
        ...
        "--config",
        nargs="?",
        default="../../ocp_airi/configs/airi/config_example.yml",
    )
...
if __name__ == "__main__":
    ...
    file_path = os.path.expanduser(
        "../ocpmodels/models/" + models_names[config["model_name"]]
    )
    ...
    valid_generator = choose_dataloader(
    ...
    try:
        ...
        print("error in dataset description")
